...
[In this PR](https://github.com/litecoinfinance/lnd/pull/773) we added a new package implementing the aezeed cipher
...
goos: linux
goarch: amd64
pkg: github.com/litecoinfinance/lnd/aezeed
...
PASS
ok      github.com/litecoinfinance/lnd/aezeed  4.168s
```
