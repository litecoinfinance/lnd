...
### Preliminaries
  In order to work with [`lnd`](https://github.com/litecoinfinance/lnd), the
...
```
go get -d github.com/litecoinfinance/lnd
cd $GOPATH/src/github.com/litecoinfinance/lnd
make && make install
```
...
Github](https://github.com/litecoinfinance/lnd/issues/20).
